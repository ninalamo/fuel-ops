    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {/* 1. Fleet Status (Capacity) */}
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-purple-100 rounded-lg">
                            <Truck className="h-5 w-5 text-purple-600" />
                        </div>
                        <span className="text-sm font-medium text-gray-500">Fleet Status</span>
                    </div>
                    <div className="text-3xl font-bold text-purple-700">{stats.tankers.inUse} / {stats.tankers.total}</div>
                    <div className="text-xs text-gray-500 mt-1">
                        Tankers in use today
                    </div>
                </div>

                {/* 2. Active Trips (Activity) */}
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-3xl font-bold text-blue-700">{stats.trips.enRoute}</div>
                    <div className="text-xs text-gray-500 mt-1">
                        Tankers currently en route
                    </div>
                </div>

                {/* 3. Action Needed (Awaiting POD) */}
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-3 mb-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div className="space-y-3">
                        <StatusRow label="Preparing" count={stats.trips.pending} color="gray" icon={Clock} />
